...
describe('Service Tests', () => {
    ...
    describe('RevenueHistory Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(RevenueHistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/revenue-histories';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RevenueHistory', () => {

                let entity: RevenueHistory;
                service.find(123).subscribe((_entity: RevenueHistory) => {
                    entity = _entity;
                });
