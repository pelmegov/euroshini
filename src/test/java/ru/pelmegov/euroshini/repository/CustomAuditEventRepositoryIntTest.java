...
import ru.pelmegov.euroshini.config.audit.AuditEventConverter;
import ru.pelmegov.euroshini.domain.PersistentAuditEvent;
...
import static ru.pelmegov.euroshini.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
